...
public class ShiroConfiguration {
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(@Qualifier("userRealm") DMSRealm realm) {
        // 创建Web安全管理器
